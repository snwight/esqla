...
<p class="p1">1&gt; git clone git@github.com:snwight/esqla.git</p>
<p class="p1">2&gt; cd esqla/priv</p>
<p class="p1">Grab erlport and clone it as-is into esqla/priv:</p>
<p class="p1">3&gt; git clone git://github.com/hdima/erlport.git</p>
<p class="p1">4&gt; cd esqla</p>
<p class="p1">Assuming you have rebar in your exec path:</p>
<p class="p1">5&gt; rebar compile</p>
<p class="p1">6&gt; cd ebin</p>
